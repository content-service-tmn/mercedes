    ...
    <div class="product-modal__content">
        ...
        <div class="product-modal__box3">
            ...
            <div class="product-modal__print">
                <a class="-color-blue link-with-border" href="https://sales.mercedes-orenburg.ru/index.php?route=car/model/printInfo&amp;order_id=<?=$info["car_id"]?>" target="_blank">
                    <b>Распечатать</b>
                </a>
            </div>
            ...
            <div class="product-modal__footer">
                ...
                <div class="xl-40 sm-100 product-modal__footer-right">
                    ...
                    <div class="mb-10">
                        <a href="https://sales.mercedes-orenburg.ru/index.php?route=car/model/printInfo&amp;order_id=<?=$info["car_id"]?>" class="-color-blue link-with-border" target="_blank">
                            <b>Распечатать</b>
                        </a>
                    </div>
                </div>
            ...
            <div class="form-type3__wrapper">
                <div class="form-type3__inner">
                    ...
                    <form id="form-issues-modal" class="CKiForm">
                        ...
                        <button type="button" class="btn btn--blue CKFormTrigger" onclick="sendRequest('#form-issues-modal', '<?=$info["car_id"]?>')">Заказать консультацию</button>
